...
} from '@common/shared/ui-components/panel/project-card-menu/project-card-menu.component';
...
export class NestedCardComponent {
  ...
  protected readonly projectCardMenuActions: readonly ProjectCardMenuAction[] = ['delete'];
