...
export type ProjectCardMenuAction = 'settings' | 'create' | 'move' | 'delete';

const PROJECT_CARD_MENU_ACTIONS: readonly ProjectCardMenuAction[] = [
  'settings',
  'create',
  'move',
  'delete',
...
export class ProjectCardMenuComponent {
  actions = input<readonly ProjectCardMenuAction[]>(PROJECT_CARD_MENU_ACTIONS);
